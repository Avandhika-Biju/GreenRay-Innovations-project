        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="Homepage.php" class="nav-item nav-link "><i class="fa fa-tachometer-alt me-2"></i>Home</a>
                    ...
                    <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-keyboard me-2"></i>Company</a>
                    <div class="dropdown-menu bg-transparent border-0">
                    <a href="NewCompanyList.php" class="dropdown-item">Company List</a>  
                    <a href="AcceptedCompany.php" class="dropdown-item">Accept</a>
                    <a href="RejectedCompany.php" class="dropdown-item">Reject</a> 
                     </div>
                    </div>
                    
                </div>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>Categorys</a>
                        <div class="dropdown-menu bg-transparent border-0">
                    ...
                    <a href="ProductType.php" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Product Type</a>
                    <a href="UserComplaint.php" class="dropdown-item">UserComplaint</a>
                    <a href="CompanyComplaint.php" class="dropdown-item">Company Complaint</a>
                    <a href="Viewfeedback.php" class="dropdown-item">Company Feedback</a>

                    <a href="Userbar.php" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Userbar</a>
