    ...
    <br><br><br><br><br><br><br><br>
        ...
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
			...
			<?php
				...
				$i=0;
			 $selQry = "select * from tbl_cart ca inner join  tbl_booking b  on b.booking_id=ca.booking_id inner join tbl_newuser u on u.user_id=b.user_id inner join  tbl_product p on ca.product_id=p.product_id WHERE p.company_id='".$_SESSION["cid"]."'";
