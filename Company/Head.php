...
<head>
    <meta charset="utf-8">
    <title>GREENRAY INNOVATIONS - Renewable Energy Website Template</title>
...
<body>
        ...
        <div class="row gx-0 d-none d-lg-flex">
            <div class="col-lg-7 px-5 text-start">
                <div class="h-100 d-inline-flex align-items-center me-4">
                    ...
                    <p class="mb-0 mr-2">&nbsp;<i class="fa fa-envelope me-3"></i>greenrayinnovations@gmail.com</p>
                    </div>
                <div class="h-100 d-inline-flex align-items-center">
                    
                    <a class="btn btn-square btn-link rounded-0" href=""><i class="fab fa-email"></i></a>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
        <a href="index.html" class="navbar-brand d-flex align-items-center border-end px-4 px-lg-5">
            <h2 class="m-0 text-primary">GREENRAY INNOVATIONS</h2>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
               ...
               <a href="BookingReport.php" class="dropdown-item">Booking Report</a>
               <a href="UserBooking.php" class="dropdown-item">UserBooking</a>
              </div>
                <a href="Staff.php" class="nav-item nav-link">Staff</a>
                ...
                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">MESSAGE</a>
                    <div class="dropdown-menu bg-light m-0">
                        <a href="PostComplaint.php" class="dropdown-item">PostComplaint</a>
                        <a href="PostedComplaint.php" class="dropdown-item">PostedComplaint</a>
                        <a href="PostFeedback.php" class="dropdown-item">PostFeedback</a>
                        <a href="PostedFeedback.php" class="dropdown-item">PostedFeedback</a>
