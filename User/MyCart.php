...
<html>
    ...
    <?php
        ...
        if (isset($_POST["btn_checkout"])) {        
                ...
                $rs = $con->query($selC);
                $row=$rs->fetch_assoc();
                $upQry1 = "update tbl_booking set booking_status='1', booking_total='".$amt."' where booking_id='" .$row["booking_id"]. "'";
                if($con->query($upQry1))
                {
    ...
    <div class="container">
        <h1>Cart</h1>
            <div class="column-labels">
                ...
                <label class="product-price" style="width: 10%; text-align:center">Rent Price</label>
        ...
        <div class="shopping-cart" style="margin-top: 50px">            <?php                
               ...
               $res = $con->query($sel);
                while ($row=$res->fetch_assoc()) {
                    ...
                    if ($rowpr=$respr->fetch_assoc()) {
                        $selstock = "select sum(stock_quantity) as stock from tbl_productstock where product_id ='".$rowpr["product_id"]."'";
                        $selstock1="select sum(cart_qty) as Qty from tbl_cart where product_id='".$rowpr["product_id"]."'";
            ...
            <div class="product">
                <div class="product-image">
                    <img src="../Assets/Files/Company/product/<?php echo $rowpr["product_image"] ?>"/>
                </div>
            ...
            <div class="totals">
                <div class="totals-item totals-item-total">
                    ...
                    <input type="hidden" id="cart-totalamt" name="carttotalamt"/>
                </div>
            </div>
