                ...
                <div class="col-lg-3">
                        ...
                        <li class="list-group-item">
                            <div class="form-check">
                                <label class="form-check-label">
                                    ...
                                    <input type="text" name="txt_cmp_id" id="txt_cmp_id" value="<?php echo $_GET["did"]?>" id="">
                                </label>
                            </div>
                        </li>
                    </ul>
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item">
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" onclick="productCheck()" class="form-check-input product_check" value="<?php echo $row["producttype_id"]; ?>" id="category"><?php echo $row["producttype_name"]; ?>
                                </label>
                            </div>
                        </li>
                        <?php
...
<script src="../Assets/Template/Search/popper.min.js"></script>
        <script>
            ...
            function productCheck(){
                    ...
                    var comp = document.getElementById('txt_cmp_id').value;
					console.log(comp);


                    $.ajax({
                        url: "../Assets/AjaxPages/AjaxSearchProduct.php?action=" + action +"&category=" + category + "&company=" + comp,
                        success: function(response) {
